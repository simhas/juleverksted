var levels = [
  {
    ...
    instructions: {
      'no': '<p>Så bra, dere rakk det! Grinchen har tullet til flex-instillingene, og dere må gjennom noen steg hjelpe nissen med å finne sekken sin, rudolf med å få kransen rundt hodet, og snømannen til å komme seg hjem i snøkulen sin. Pst: her er det viktig at du løser alle oppgavene! </br></br>Hint: <code>justify-content</code> (hold musepekeren over for gyldige properties) </p> <img src="http://code.org/api/hour/begin_flexbox_froggy.png">' 
	},
    board: 'g',
...
var levelWin = {
  name: 'win',
  instructions: {
    'en': '<p>Yey! Du hjalp nissen, rudolf og snømannen med å finne tilbake til tingene sine. Se hvor glade de ble!</p><p>Men Grinchen er fortsatt ingen steder å se, du må skynde deg videre for å fange ham! Jeg tror en av frontendnissene vet hvor dere må dra for å komme videre, spør en av dem! ;) </p>'
  },
